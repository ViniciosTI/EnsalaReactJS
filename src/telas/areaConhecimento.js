...
class AreaConhecimento extends React.Component {
  ...
  inserir = async o => {
    ...
    await POST("areaConhecimento/inserir", o)
      .finally(response => {
        this.buscar();
      })
  }
  ...
  removerLinha = async (id) => {
    this.setState({ loading: true });
    await DELETE("areaConhecimento/remover/" + id)
      .finally(response => {
        this.buscar();
      })
  }
  ...
  alterar = async o => {
    this.setState({ loading: true });
    await PUT("areaConhecimento/alterar", o)
      .finally(() => {
  ...
  buscarPorId = async (id) => {
    ...
    // segundo atualiza <----------------------------
    this.setState({ loading: true })
    await GET("areaConhecimento/buscar/" + id)
      .then(response => {
