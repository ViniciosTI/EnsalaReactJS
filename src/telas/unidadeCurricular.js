...
class UnidadeCurricular extends React.Component {
    ...
    inserir = async o => {
        ...
        await POST("unidadeCurricular/inserir", o)
            .finally(response => {
                this.buscar();
            })
    }
    ...
    removerLinha = async (id) => {
        this.setState({ loading: true });
        await DELETE("unidadeCurricular/remover/" + id)
            .finally(response => {
                this.buscar();
            })
    }
    ...
    alterar = async o => {
        this.setState({ loading: true });
        await PUT("unidadeCurricular/alterar", o)
            .finally(() => {
    ...
    buscarPorId = async (id) => {
        ...
        // segundo atualiza <----------------------------
        this.setState({ loading: true })
        await GET("unidadeCurricular/buscar/" + id)
            .then(response => {
